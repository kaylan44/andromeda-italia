      ...
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-20">
        <div className="grid md:grid-cols-4 gap-12 md:gap-8 mb-14">
          ...
          <div className="md:col-span-2">
            <div className="font-display text-3xl font-light tracking-[0.25em] text-warm-white mb-4">
              ANDROMEDA
            </div>
            ...
            <div className="flex items-center gap-4 mt-7">
              {[
                ...
                <a
                  ...
                  className="w-9 h-9 border border-white/10 flex items-center justify-center text-warm-white/40 hover:text-gold hover:border-gold/40 transition-all duration-300"
                >
                  {social.icon}
                </a>
              ))}
