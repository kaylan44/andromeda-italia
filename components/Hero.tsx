  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        {/* Title */}
        <h1
          className="font-display text-[clamp(2.5rem,10vw,6rem)] md:text-[clamp(4rem,10vw,10rem)] font-light leading-none tracking-[0.08em] text-warm-white mb-6"
          style={{
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-50"
        ...
        <span className="text-warm-white text-xs tracking-widest font-sans uppercase">{t("scroll")}</span>
